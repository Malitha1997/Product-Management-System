...
<div class="container" style="font-family:poppins">
        ...
        <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><h10>Customer Registration</h10></li>
                </ol>
            </nav>
        </div>
    </div> 
    <div class="row">
        <h2 style="color:#1028D1;text-align:center;font-weight:bold">Customer Registration</h2>
    </div>
    <form method="POST" action="{{route('customers.store')}}">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <input class="form-control-md" name="code" id="code" placeholder="Enter the code">
            </div>
        </div>
        <div class="row">
            <div class="col-6" style="text-align:right">
            ...
            <div class="col-6">
                <input class="form-control-md" name="address" id="address" placeholder="Enter the address">
            </div>
        </div>
        <div class="row">
            <div class="col-6" style="text-align:right">
            ...
            <div class="col-6">
                <input type="text" class="form-control-md" name="contact" id="contact" placeholder="Enter the contact no.">
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-12" style="text-align:center">
                <a class="btn btn-success" type="button" href="{{route('customers.index')}}" style="margin-top:5%;">Customer LIST</a>
            </div> 
        </div>
